...
public:
	...
	void RenderScene (void)
	{
		if (m_pScene)
		{
			...
			glLoadIdentity();
			gluPerspective (sceneCam.GetFOV (), (GLdouble)WINDOW_WIDTH/WINDOW_HEIGHT, sceneCam.GetNearClip (), sceneCam.GetFarClip ());
			...
			for (unsigned int n = 0; n < numObjs; n++)
			{
				...
				if (sceneObj->IsSphere ())
				{
					...
					// Draw the Sphere
					glutSolidSphere (((SceneSphere *)sceneObj)->radius, 100, 100);
				}
				else if (sceneObj->IsTriangle ())
				{
				...
				else if(sceneObj->IsSquare()){
					SceneMaterial sceneMat;

					// Set Transformations
					Vector translate = ((SceneSquare *)sceneObj)->position;
					glTranslatef (translate.x, translate.y, translate.z);
					glRotatef (((SceneSquare *)sceneObj)->rotation.x, 1.0f, 0.0f, 0.0f);
					glRotatef (((SceneSquare *)sceneObj)->rotation.y, 0.0f, 1.0f, 0.0f);
					glRotatef (((SceneSquare *)sceneObj)->rotation.z, 0.0f, 0.0f, 1.0f);
					glScalef (((SceneSquare *)sceneObj)->scale.x, ((SceneSquare *)sceneObj)->scale.y, ((SceneSquare *)sceneObj)->scale.z);

					// Specular Properties set before glBegin ()
					sceneMat = m_pScene->GetMaterial (((SceneSquare *)sceneObj)->material[0]);
					glMaterialfv (GL_FRONT_AND_BACK, GL_SPECULAR, (GLfloat *)&sceneMat.specular);
					glMaterialf(GL_FRONT, GL_SHININESS, sceneMat.shininess);
					...
					sceneMat = m_pScene->GetMaterial (((SceneSquare *)sceneObj)->material[0]);
					glColor3fv ((GLfloat *)&sceneMat.diffuse);
					glTexCoord2f (((SceneSquare *)sceneObj)->u[0], ((SceneSquare *)sceneObj)->v[0]);
					glNormal3f (((SceneSquare *)sceneObj)->normal[0].x, ((SceneSquare *)sceneObj)->normal[0].y, ((SceneSquare *)sceneObj)->normal[0].z);
					glVertex3f (((SceneSquare *)sceneObj)->vertex[0].x, ((SceneSquare *)sceneObj)->vertex[0].y, ((SceneSquare *)sceneObj)->vertex[0].z);

					sceneMat = m_pScene->GetMaterial (((SceneSquare *)sceneObj)->material[1]);
					glColor3fv ((GLfloat *)&sceneMat.diffuse);
					glTexCoord2f (((SceneSquare *)sceneObj)->u[1], ((SceneSquare *)sceneObj)->v[1]);
					glNormal3f (((SceneSquare *)sceneObj)->normal[1].x, ((SceneSquare *)sceneObj)->normal[1].y, ((SceneSquare *)sceneObj)->normal[1].z);
					glVertex3f (((SceneSquare *)sceneObj)->vertex[1].x, ((SceneSquare *)sceneObj)->vertex[1].y, ((SceneSquare *)sceneObj)->vertex[1].z);

					sceneMat = m_pScene->GetMaterial (((SceneTriangle *)sceneObj)->material[2]);
					glColor3fv ((GLfloat *)&sceneMat.diffuse);
					glTexCoord2f (((SceneSquare *)sceneObj)->u[2], ((SceneSquare *)sceneObj)->v[2]);
					glNormal3f (((SceneSquare *)sceneObj)->normal[2].x, ((SceneSquare *)sceneObj)->normal[2].y, ((SceneSquare *)sceneObj)->normal[2].z);
					glVertex3f (((SceneSquare *)sceneObj)->vertex[2].x, ((SceneSquare *)sceneObj)->vertex[2].y, ((SceneSquare *)sceneObj)->vertex[2].z);

					sceneMat = m_pScene->GetMaterial (((SceneTriangle *)sceneObj)->material[3]);
					glColor3fv ((GLfloat *)&sceneMat.diffuse);
					glTexCoord2f (((SceneSquare *)sceneObj)->u[3], ((SceneSquare *)sceneObj)->v[3]);
					glNormal3f (((SceneSquare *)sceneObj)->normal[3].x, ((SceneSquare *)sceneObj)->normal[3].y, ((SceneSquare *)sceneObj)->normal[3].z);
					glVertex3f (((SceneSquare *)sceneObj)->vertex[3].x, ((SceneSquare *)sceneObj)->vertex[3].y, ((SceneSquare *)sceneObj)->vertex[3].z);
